...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/FQdLtQGueg)
...
```sh
npx nx serve react-redux
```

To create a production bundle:

```sh
npx nx build react-redux
```

To see all available targets to run for a project, run:

```sh
npx nx show project react-redux
```
